                  ...
                  <article class="thumb grid-item post-38498">
                     <div class="halim-item">
                        <a class="halim-thumb" href="{{route('movie',$hot->slug)}}" title="{{$hot->title}}">
                           ...
                           {{-- <figure><img class="lazy img-responsive" src="{{asset($hot->image)}}" alt="{{$hot->title}}" title=""></figure> --}}
                           <span class="status">
                              @if($hot->resolution==0)
                                 SD
                           ...
                           <span class="episode"><i class="fa fa-play" aria-hidden="true"></i>
                              {{$hot->episode_count}} / {{$hot->sotap}} Tập ||                             
                                 @if($hot->phude==0)
                                    @if($hot->episode_count == $hot->sotap)
                     ...
                     <article class="col-md-3 col-sm-3 col-xs-6 thumb grid-item post-37606">
                        <div class="halim-item">
                           <a class="halim-thumb" href="{{route('movie',$mov->slug)}}">
                              ...
                              {{-- <figure><img class="lazy img-responsive" src="{{asset($mov->image)}}" alt="{{$mov->title}}" title=""></figure> --}}
                              <span class="status">
                                 @if($mov->resolution==0)
                                    SD
